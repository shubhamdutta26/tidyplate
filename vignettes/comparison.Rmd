...
The `plater` package was an inspiration for me to write `tidyplate`. However there were two issues with `plater::read_plate()` function that I wanted to fix. These were:
...
![](images/comparison_plot.png){width="523"}
