...
The goal of plateTransformR is to convert different sizes of plates used in scientific studies to a tidy dataframe or tibble. plateTransformR accepts xlsx and csv files formatted in a specific way as input. plateTransformR supports 6-well, 12-well, 24-well, 48-well, 96-well, 384-well, and 1536-well plates.

## Installation

You can install the development version of plateTransformR from [GitHub](https://github.com/) with:
...
knitr::include_graphics("man/figures/README_function_image.png")
```
